...
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: OPTIONS CONFIGURATIONS                           #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: GET THE ARGUMENTS COMMAND LINE                   #")
cat("\n#####################################################################\n\n")
args <- commandArgs(TRUE)


cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: DATASET INFORMATION                              #")
cat("\n#####################################################################\n\n")
ds <- datasets[args[1],]

number_dataset <- as.numeric(args[1])
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: NUMBER DATASET: ", number_dataset, "             #")
cat("\n#####################################################################\n\n")


number_cores <- as.numeric(args[2])
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: GET THE NUMBER CORES: ", number_cores, "         #")
cat("\n#####################################################################\n\n")


number_folds <- as.numeric(args[3])
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: GET THE NUMBER FOLDS: ", number_folds, "         #")
cat("\n#####################################################################\n\n")


similarity <- toString(args[4])
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: GET THE STRING SIMILARITY: ", similarity, "      #")
cat("\n#####################################################################\n\n")


folderResults <- toString(args[5])
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: GET THE STRING FOLDER RESULTS: ", folderResults, " #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: CREATING FOLDER RESULTS TEMP                     #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: CREATING DIRECTORIES                             #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: COMPRESS TEST RESULTS                             #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-KNN-NH: COMPRESS VALIDATE RESULTS                             #")
cat("\n#####################################################################\n\n")
